...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/myip_pwm_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef myip_pwm_tb_include_vh_"
	puts $fp "`define myip_pwm_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/myip_pwm_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "myip_pwm_bfm_${i}"
...
remove_files -quiet -fileset sim_1 myip_pwm_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top myip_pwm_tb [get_filesets sim_1]
