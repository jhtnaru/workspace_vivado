...
#
# Script generated by Vivado on Fri Sep 05 11:20:13 KST 2025
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/user16/workspace_vivado/basic_test/basic_test.cache/compile_simlib/xcelium"
  fi
