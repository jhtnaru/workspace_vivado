...
module pwm_Nstep (
    ...
    parameter duty_step_N   = 4096;              // Duty Step, ARR Auto Reload Register
...
module pwm_4096step (
    ...
    wire pwm50, pwm1k, pwm10k, pwm100k, pwm1m;
    pwm_Nstep #(.pwm_freq(50))        pwm_50   (clk, reset_p, duty, pwm50);
    pwm_Nstep #(.pwm_freq(1_000))     pwm_1k   (clk, reset_p, duty, pwm1k);
    pwm_Nstep #(.pwm_freq(10_000))    pwm_10k  (clk, reset_p, duty, pwm10k);
    pwm_Nstep #(.pwm_freq(100_000))   pwm_100k (clk, reset_p, duty, pwm100k);
    pwm_Nstep #(.pwm_freq(1_000_000)) pwm_1m   (clk, reset_p, duty, pwm1m);
