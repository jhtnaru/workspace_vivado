...
#
# Script generated by Vivado on Mon Sep 22 17:47:35 KST 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xadc_wiz_0 xil_defaultlib.xadc_wiz_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xadc_wiz_0 -key {Behavioral:sim_1:Functional:xadc_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/soc_servo180.protoinst" -protoinst "protoinst_files/soc_stepper.protoinst" -protoinst "protoinst_files/bd_a25f.protoinst" -protoinst "protoinst_files/soc_sensor_dgt.protoinst" -protoinst "protoinst_files/bd_2391.protoinst" -protoinst "protoinst_files/soc_watch.protoinst" -protoinst "protoinst_files/bd_ebb4.protoinst" -protoinst "protoinst_files/soc_ultrasonic.protoinst" -protoinst "protoinst_files/bd_5040.protoinst" -protoinst "protoinst_files/soc_txtlcd.protoinst" -protoinst "protoinst_files/bd_b74d.protoinst" -protoinst "protoinst_files/soc_stop_watch.protoinst" -protoinst "protoinst_files/bd_85ae.protoinst" -protoinst "protoinst_files/soc_rtc_read.protoinst" -protoinst "protoinst_files/bd_fdbf.protoinst" -protoinst "protoinst_files/soc_pwm.protoinst" -protoinst "protoinst_files/bd_1d9d.protoinst" -protoinst "protoinst_files/soc_pwm_4096step.protoinst" -protoinst "protoinst_files/bd_370f.protoinst" -protoinst "protoinst_files/soc_keypad.protoinst" -protoinst "protoinst_files/soc_intc.protoinst" -protoinst "protoinst_files/soc_intc_stopwatch.protoinst" -protoinst "protoinst_files/bd_57e4.protoinst" -protoinst "protoinst_files/soc_hello.protoinst" -protoinst "protoinst_files/bd_bddd.protoinst" -protoinst "protoinst_files/soc_dht11.protoinst" -protoinst "protoinst_files/bd_f5a2.protoinst" -protoinst "protoinst_files/soc_dht11_i2c.protoinst" -protoinst "protoinst_files/bd_a70c.protoinst" -protoinst "protoinst_files/soc_btn_fnd.protoinst" -log simulate.log
}
