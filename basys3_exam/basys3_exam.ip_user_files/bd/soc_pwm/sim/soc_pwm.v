...
(* CORE_GENERATION_INFO = "soc_pwm,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=soc_pwm,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=16,numNonXlnxBlks=5,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=6,da_board_cnt=2,da_clkrst_cnt=1,da_microblaze_riscv_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "soc_pwm.hwdef" *) 
module soc_pwm
   (pwm_0,
    pwm_1,
    pwm_2,
  ...
  soc_pwm_myip_pwm_1_0 myip_pwm_1
       (.pwm(pwm_1),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
  ...
  soc_pwm_myip_pwm_2_0 myip_pwm_2
       (.pwm(pwm_2),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
  ...
  soc_pwm_myip_pwm_3_0 myip_pwm_3
       (.pwm(pwm_3),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
  ...
  soc_pwm_myip_pwm_4_0 myip_pwm_4
       (.pwm(pwm_4),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
